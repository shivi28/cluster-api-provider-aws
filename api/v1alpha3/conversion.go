...
func (r *AWSMachine) ConvertTo(dstRaw conversion.Hub) error {
	...
	dst.Spec.AMIType = restored.Spec.AMIType
	return nil
}
...
func (r *AWSMachineTemplate) ConvertTo(dstRaw conversion.Hub) error {
	...
	dst.Spec.Template.Spec.AMIType = restored.Spec.Template.Spec.AMIType
	return nil
}
...
func Convert_v1alpha3_AWSMachineSpec_To_v1alpha4_AWSMachineSpec(in *AWSMachineSpec, out *v1alpha4.AWSMachineSpec, s apiconversion.Scope) error {
