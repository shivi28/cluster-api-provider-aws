...
func (r *AWSMachinePool) ConvertTo(dstRaw conversion.Hub) error {
	...
	dst.Spec.AWSLaunchTemplate.AMIType = restored.Spec.AWSLaunchTemplate.AMIType
	return nil
}
...
// Convert_v1alpha4_AWSLaunchTemplate_To_v1alpha3_AWSLaunchTemplate is conversion function
func Convert_v1alpha4_AWSLaunchTemplate_To_v1alpha3_AWSLaunchTemplate(in *v1alpha4.AWSLaunchTemplate, out *AWSLaunchTemplate, s apiconversion.Scope) error {
